...
for key, mydataset in combination_dataset.items():
    ...
    train_X, test_X, train_Y, test_Y = train_test_split(feature, target, test_size = .3, shuffle=True, stratify = target)
    ...
    model_test = GridSearchCV(model, param_grid, scoring="roc_auc", cv = 2, verbose=2)
